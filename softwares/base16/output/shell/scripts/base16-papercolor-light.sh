...
color00="f3/f3/f3" # Base 00 - Black
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Ph f3f3f3 # background
  ...
  put_template_custom Pm f3f3f3 # cursor text
else
